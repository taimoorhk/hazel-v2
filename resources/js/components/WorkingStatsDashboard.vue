<template>
  <div class="working-stats-dashboard">
    <!-- Loading State -->
        ...
        <div class="charts-grid">
          ...
          <div class="chart-card">
            ...
            <div class="chart-container">
              <div class="chart-placeholder" v-if="!moodChartData.labels.length">
                <div class="placeholder-content">
                  <div class="placeholder-icon">📊</div>
                  <p class="placeholder-text">Loading chart data...</p>
                </div>
              </div>
          ...
          <div class="chart-card">
            ...
            <div class="chart-container">
              <div class="chart-placeholder" v-if="!engagementChartData.labels.length">
                <div class="placeholder-content">
                  <div class="placeholder-icon">📊</div>
                  <p class="placeholder-text">Loading chart data...</p>
                </div>
          ...
          <div class="chart-card">
            ...
            <div class="chart-container">
              <div class="chart-placeholder" v-if="!energyLevelChartData.labels.length">
                <div class="placeholder-content">
                  <div class="placeholder-icon">📊</div>
                  <p class="placeholder-text">Loading chart data...</p>
                </div>
          ...
          <div class="chart-card">
            ...
            <div class="chart-container">
              <div class="chart-placeholder" v-if="!cognitiveFunctionChartData.labels.length">
                <div class="placeholder-content">
                  <div class="placeholder-icon">📊</div>
                  <p class="placeholder-text">Loading chart data...</p>
                </div>
          ...
          <div class="chart-card">
            ...
            <div class="chart-container">
              <div class="chart-placeholder" v-if="!memoryRecallChartData.labels.length">
                <div class="placeholder-content">
                  <div class="placeholder-icon">📊</div>
                  <p class="placeholder-text">Loading chart data...</p>
                </div>
          ...
          <div class="chart-card">
            ...
            <div class="chart-container">
              <div class="chart-placeholder" v-if="!sleepQualityChartData.labels.length">
                <div class="placeholder-content">
                  <div class="placeholder-icon">📊</div>
                  <p class="placeholder-text">Loading chart data...</p>
                </div>
...
// Chart data computed properties with guaranteed data
const moodChartData = computed(() => {
  if (!statsData.value?.canary_analysis_files || statsData.value.canary_analysis_files.length === 0) {
    // Fallback data - always show something
    console.log('📊 Using fallback mood data')
    return {
...
const loadStats = async () => {
  ...
  try {
    ...
    if (result.success && result.data) {
      ...
      console.log('📊 Loaded working stats data:', result.data)
    } else {
      throw new Error(result.message || 'Failed to load enhanced canary data')
    }
  } catch (err) {
    console.error('Error loading working stats:', err)
